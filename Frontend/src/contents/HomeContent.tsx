...
const HomeContent: React.FC = () => {
  const steps: Step[] = [
    { num: '01', icon: '📝', title: 'Créez votre annonce', desc: 'Publiez une offre avec la devise et le taux souhaité.', color: 'green' },
    { num: '02', icon: '🔍', title: 'Matching automatique', desc: 'Notre algorithme trouve votre contrepartie idéale.', color: 'blue' },
    { num: '03', icon: '🔒', title: 'Escrow sécurisé', desc: 'Les fonds sont bloqués sur un compte séquestre neutre.', color: 'orange' },
    { num: '04', icon: '✅', title: 'Virement final', desc: 'Les fonds sont libérés dès confirmation des deux dépôts.', color: 'green' }
  ];
    ...
    <div className="home-content-wrapper">
          ...
          <div className="row align-items-center min-vh-100">
            ...
            <div className="col-lg-6 hero-left">
              ...
              <div className="hero-actions d-flex flex-wrap gap-3 mb-5">
                <button className="btn btn-hero-primary shadow">
                  <span></span> Commencer l'échange
                </button>
            ...
            {/* Colonne Droite: Visuel avec Background flottant */}
            <div className="col-lg-6 hero-visual position-relative mt-5 mt-lg-0">
              
              {/* L'arrière-plan qui flotte constamment derrière les éléments */}
              ...
              <div className="float-card left glass-effect">
              ...
              <div className="phone-mockup shadow-2xl">
                ...
                <button className="btn btn-match w-100 py-2 fw-bold">⚡ Matcher une offre</button>
              </div>

              <div className="float-card right glass-effect">
                <div className="float-card-label">Escrow sécurisé</div>
                <div className="float-card-val orange">🔒 Fonds protégés</div>
              </div>
            </div>
      ...
      <div className="trust-bar bg-light border-top border-bottom py-4" id='security'>
        <div className="container d-flex flex-wrap justify-content-between align-items-center text-center">
          <div className="trust-item mx-2"><span className="me-2">🔐</span> Sécurité PCI-DSS</div>
          <div className="trust-item mx-2"><span className="me-2">📱</span> Mobile Money</div>
          <div className="trust-item mx-2"><span className="me-2">🤖</span> Assistant IA 24/7</div>
          <div className="trust-item mx-2"><span className="me-2">⚡</span> Transactions rapides</div>
        </div>
      </div>
          ...
          {steps.map((step, i) => (
            <div className="col-md-6 col-lg-3" key={i}>
              <div className="step-card h-100 p-4 border-0 shadow-sm rounded-4 position-relative overflow-hidden">
                ...
                <div className={`step-icon mb-3 fs-3 ${step.color}`}>{step.icon}</div>
      ...
      <section className="container my-5">
        <div className="cta-container-modern p-5 rounded-5 text-center text-white position-relative overflow-hidden shadow-lg">
          <div className="cta-content position-relative z-index-2">
            ...
            <button className="btn btn-light btn-lg px-5 py-3 fw-bold text-red shadow">
